...
for mycolumn = 1:5
    Cach = Cach1(:,mycolumn);
    [t,q] = ode23(@basicspringsrhs,[0,20],q0);
    ...
    % plot data
    plot(myT,Calcium,linecol(mycolumn))
...
xlabel('Time (seconds)')
ylabel('Force')
title('Forces at Further Distances')
hold off
return
...
function dx = basicspringsrhs(t,x)
...
dx(2,1) = x(1) - epsilon*x(2) - VM4 * (x(2)^uu/( x(2)^uu + k4^uu )) + PMV*(1 - x(5)^r2/( kV^r2 + x(5)^r2 ));
...
dx(7,1)  = r(1)*x(9) + r(3)*x(11) + r(8)*x(14) - f(1)*x(1)*x(1)*x(7) - f(3)*x(7)*x(8) - f(8)*x(7)*x(15);
dx(8,1)  = r(3)*x(11) + r(4)*x(12) + r(5)*x(13) - f(3)*x(7)*x(8) - f(4)*x(8)*x(9) - f(5)*x(8)*x(10);
dx(9,1)  = f(1)*x(1)*x(1)*x(7) + r(2)*x(10) + r(4)*x(12) + f(9)*x(1)*x(1)*x(14) - r(1)*x(9) - f(2)*x(1)*x(1)*x(9) - f(4)*x(8)*x(9) - r(9)*x(9)*x(15);
dx(10,1)  = f(2)*x(1)*x(1)*x(9) + r(5)*x(13) - r(2)*x(10) - f(5)*x(8)*x(10);
dx(11,1)  = f(3)*x(7)*x(8) + r(6)*x(12) - r(3)*x(11) - f(6)*x(1)*x(1)*x(11);
dx(12,1)  = f(4)*x(8)*x(9) + f(6)*x(1)*x(1)*x(11) + r(7)*x(13) - r(4)*x(12) - r(6)*x(12) - f(7)*x(1)*x(1)*x(12);
dx(13,1)  = f(5)*x(8)*x(10) + f(7)*x(1)*x(1)*x(12) - r(5)*x(13) - r(7)*x(13);
dx(14,1)  = f(8)*x(7)*x(15) + r(9)*x(9)*x(15) - r(8)*x(14) - f(9)*x(1)*x(1)*x(14);
dx(15,1) = r(8)*x(14) + f(9)*x(1)*x(1)*x(14) - f(8)*x(7)*x(15) - r(9)*x(9)*x(15);
