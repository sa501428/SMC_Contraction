...
% lala=5: 5 different cleft lengths
...
figure(2)
plot(0:dt:ttime,TAch(:,1),'k')
hold on
plot(0:dt*20:ttime,TAch(1:20:end,2),'ko')
plot(0:dt:ttime,TAch(:,3),'k--')
plot(0:dt*20:ttime,TAch(1:20:end,4),'k*')
plot(0:dt*20:ttime,TAch(1:20:end,5),'kx')
plot(0:dt:ttime,TAch(:,2),'k')
plot(0:dt:ttime,TAch(:,4),'k')
plot(0:dt:ttime,TAch(:,5),'k')
xlabel('Time (\mu s)')
ylabel('ACH (\mu M)')
...
xlabel('Synapse Width (nm)')
ylabel('Peak ACh concentration (\mu M)')
